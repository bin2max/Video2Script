...
class Video2ScriptGUI:
    ...
    def create_file_selection_area(self, parent):
        """创建文件选择区域"""
        # 视频文件选择
        ttk.Label(parent, text="视频文件:").grid(row=1, column=0, sticky=tk.W, pady=5)
        
        video_frame = ttk.Frame(parent)
        video_frame.grid(row=1, column=1, columnspan=2, sticky=(tk.W, tk.E), pady=5)
        ...
        # 模板文件选择
        ttk.Label(parent, text="文档模板:").grid(row=2, column=0, sticky=tk.W, pady=5)
        
        template_frame = ttk.Frame(parent)
        template_frame.grid(row=2, column=1, columnspan=2, sticky=(tk.W, tk.E), pady=5)
        ...
        self.template_button.grid(row=0, column=1)
    
    def create_processing_area(self, parent):
        """创建处理按钮区域"""
        processing_frame = ttk.LabelFrame(parent, text="处理操作", padding="10")
        processing_frame.grid(row=3, column=0, columnspan=3, sticky=(tk.W, tk.E), pady=10)
    ...
    def create_content_area(self, parent):
        ...
        content_frame.grid(row=4, column=0, columnspan=3, sticky=(tk.W, tk.E, tk.N, tk.S), pady=10)
        ...
        self.raw_text = scrolledtext.ScrolledText(self.raw_text_frame, wrap=tk.WORD, height=15)
        ...
        self.optimized_text = scrolledtext.ScrolledText(self.optimized_text_frame, wrap=tk.WORD, height=15)
        ...
        self.structured_text = scrolledtext.ScrolledText(self.structured_frame, wrap=tk.WORD, height=15)
